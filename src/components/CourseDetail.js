              ...
              <div className="w-full bg-white text-primary">
                ...
                <div className="p-5 mt-1">
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm text-gray-500 text-center">Starting at $19.00 per month after trial</p>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <button onClick={() => dispatch(addToCart(product))} className="text-center py-3 bg-white border border-primary font-medium text-lg hover:bg-gray-100">
                      Add to cart
                    </button>
