...
import Breadcrumbs from './homeContent/getBreadcrumbs ';
...
const ProductDetail = () => {
  ...
  return product ? (
    ...
    <div className="flex gap-2 items-center">
      ...
      <button className="font-medium border-custom border-black h-full my-1.5 py-2 px-5 text-white bg-black hover:bg-gray-800">
        Sign up
      </button>
  ...
  <div className="w-full">
      ...
      <div className="relative w-custom mx-auto">
        <div className="p-rightBox flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="text-4xl font-medium tracking-wide">{product.name}</h1>
            <p className="text-xl">Become a Full-Stack Web Developer with just ONE course. HTML, CSS, Javascript, Node,
        ...
        <div className="absolute w-box shadow-lg border-white border-custom right-0 top-0">
          <div className="w-full">
            <div className="relative w-full h-auto overflow-hidden">
              <img className="w-full h-auto" src="https://img-c.udemycdn.com/course/240x135/567828_67d0.jpg"
          ...
          <div className="w-full bg-white text-primary">
            ...
            <div className="p-5 mt-1">
              <div className="flex flex-col gap-2">
                <p className="font-life-bold text-2xl leading-7">Subscribe to Udemy’s top courses</p>
                <p className="text-sm">Get this course, plus 11,000+ of our top-rated courses, with Personal Plan.
                  <a href="" className="text-sm font-medium text-secondary-bold underline underline-offset-4">Learn more</a>
                </p>
                <button className="w-full text-center bg-secondary-screen text-white font-medium py-3 mt-2">Try Personal
                  Plan for free
                </button>
                <p className="text-sm text-gray-500 text-center">Starting at A$19.00 per month after trial</p>
              ...
              <div className="flex flex-col gap-4">
                <p className="font-medium  text-2xl">A$42.99</p>
                <button className="text-center py-3 bg-white border border-primary font-medium text-lg hover:bg-gray-100">
                  Add to cart
                </button>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium underline underline-offset-4">Gift this course</span>
                  <span className="font-medium underline underline-offset-4">Apply coupon</span>
                </div>
                <form className="relative w-full">
                  <input className="w-full px-3.5 py-2.5 border border-primary focus:outline-0" type="text" placeholder="Enter coupon"></input>
                  <button className="absolute right-0 font-medium text-white bg-primary border border-primary py-2.5 px-4">
                    Apply
                  </button>
                </form>
              </div>
    ...
    <div className="w-custom p-rightBox my-10 mx-auto">
      ...
      <div className="py-3 px-4 border border-gray-300 mt-10">
        ...
        <p className="text-gray-600 -mt-0.5">This course was selected for our collection of top-rated courses trusted by
      ...
      <div className="bg-grayLight p-8 flex justify-between items-center gap-5 mt-7">
        <div className="flex flex-col justify-between h-44">
          ...
          <p className="text-gray-600">This course includes our updated coding exercises so you can practice your skills as
            you learn.</p>
      ...
      <div className="mt-8">
        ...
        <div className="mt-6">
          ...
          <div className="mt-3">
            <div className="flex justify-between items-center px-4 py-3 border border-gray-300 bg-grayLight">
          ...
          <div className="border border-black hover:bg-gray-100 font-medium py-3 text-center cursor-pointer mt-5"> 13 more
            sections
          </div>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <p className="my-2">Become a Python Programmer and learn one of employer's most requested skills of 2023!
          <br></br>
          <br></br>
      ...
      <div className="mt-8">
        ...
        <p className="text-secondary-bold text-xl font-medium underline underline-offset-4 mt-5">Joe Portilla</p>
        ...
        <div className="flex gap-4 items-center mt-4 h-32">
          <img className="aspect-square h-full rounded-full" src="https://img-c.udemycdn.com/user/200_H/9685726_67e7_4.jpg"
        ...
        <p className="my-4">Jose Marcial Portilla has a BS and MS in Mechanical Engineering from Santa Clara University and
          years of experience as a professional instructor and trainer for Data Science, Machine Learning and Python
          Programming. He has publications and patents in various fields such as microfluidics, materials science, and
          data science. Over the course of his career he has developed a skill set in analyzing data and he hopes to use
          his experience in teaching and data science to help other people learn the power of programming, the ability
          to analyze data, and the skills needed to present the data in clear and beautiful visualizations. Currently he
          works as the Head of Data Science for Pierian Training and provides in-person data science and python
          programming training courses to employees working at top companies, including General Electric, Cigna,
          SalesForce, Starbucks, McKinsey and many more. Feel free to check out the website link to find out more
  ...
  <div className="w-full bg-grayDark text-white pt-8 mt-10">
    ...
    <div className="px-10 flex justify-between">
      ...
      <button className="border border-white h-12 px-6 hover:bg-gray-800 font-bold">
        <i className="fa-solid fa-globe mr-2" style={{color: color}}></i>
        English
      </button>
    </div>
