            ...
            <div className="w-full">
                <form onSubmit={handleSubmit} className="w-96 mx-auto my-12 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        <button
                            className="hover:bg-gray-100 w-full h-12 border border-black flex items-center px-3 py-2 gap-2">
                        ...
                        <div className="w-full h-12 border border-black px-3 py-2 flex items-center">
                            <input name="username" className="font-medium focus:outline-0" type="text" id="email"
                                   placeholder="Email"
                                   value={username} onChange={e => setUsername(e.target.value)}></input>
                        </div>
                        <div className="w-full h-12 border border-black px-3 py-2 flex items-center">
                            <input name="password" className="font-medium focus:outline-0" id="password"
                                   placeholder="Password"
                                   type="password" value={password} onChange={e => setPassword(e.target.value)}></input>
                        </div>
                    </div>
                    <button type="submit"
                            className="mt-1 bg-purple-600 hover:bg-secondary-dark font-medium text-white py-3">Log
                        in
                    </button>
                    ...
                    <div className="flex flex-col items-center gap-1">
                        ...
                        <a className="font-medium text-sm underline text-secondary-bold underline-offset-4" href="">Log
                            in with your
                            organization</a>
                    </div>
                </form>
